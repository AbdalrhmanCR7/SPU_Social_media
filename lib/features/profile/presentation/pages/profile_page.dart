            ...
            children: [
              BlocBuilder<ProfileBloc, ProfileState>(
                builder: (context, state) {
                  if (state is LoadedState) {
                    _bioController.text =
                        state.profileUser.bio ?? ""; // Load bio
                    return Center(
                      child: Text(
                        ...
                        if (state is LoadedState &&
                          ...
                          return CircleAvatar(
                            ...
                            backgroundImage: NetworkImage(
                                state.profileUser.profileImageUrl!),
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  final updatedProfile =
                      (context.read<ProfileBloc>().state as LoadedState)
                          .profileUser
                          .copyWith(newBio: updatedBio);
                  context
                      .read<ProfileBloc>()
